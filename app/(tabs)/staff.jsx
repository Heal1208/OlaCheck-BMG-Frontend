...
export default function StaffScreen() {
    ...
    const renderItem = ({ item }) => (
        <View style={styles.card}>
            <View style={[styles.avatar, { backgroundColor: item.is_active ? PURPLE : "#ccc" }]}>
...
const styles = StyleSheet.create({
    ...
    roleBadge: { backgroundColor: "#F0F0FF", borderRadius: 6, paddingHorizontal: 8, paddingVertical: 3 },
