...
export default function ProfileScreen() {
    ...
    if (!user) return <View style={styles.center}><ActivityIndicator color={PURPLE} /></View>;
...
const styles = StyleSheet.create({
    ...
    headerBg: { backgroundColor: PURPLE, paddingTop: 52, paddingBottom: 64, paddingHorizontal: 20 },
    headerTitle: { fontSize: 20, fontWeight: "800", color: "#fff" },
    avatarWrap: { alignItems: "center", marginTop: -40, marginBottom: 24 },
    avatar: { width: 80, height: 80, borderRadius: 40, backgroundColor: PURPLE, alignItems: "center", justifyContent: "center", borderWidth: 4, borderColor: "#fff" },
    avatarLetter: { fontSize: 36, fontWeight: "800", color: "#fff" },
    name: { fontSize: 20, fontWeight: "800", color: "#111", marginTop: 10 },
    roleBadge: { marginTop: 6, backgroundColor: "#F0F0FF", borderRadius: 20, paddingHorizontal: 14, paddingVertical: 5 },
    roleText: { fontSize: 13, color: PURPLE, fontWeight: "600" },
    ...
    infoIcon: { width: 32, height: 32, borderRadius: 10, backgroundColor: "#F0F0FF", alignItems: "center", justifyContent: "center" },
    ...
    saveBtn: { backgroundColor: PURPLE, borderRadius: 10, paddingVertical: 14, alignItems: "center" },
